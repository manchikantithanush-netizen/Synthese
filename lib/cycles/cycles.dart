...
class _CyclesPageState extends State<CyclesPage>
    with CyclesMechanism<CyclesPage> {
  ...
  void _showHelpBottomSheet() async {
    ...
    await Navigator.push(
      ...
      MaterialPageRoute(
        builder: (context) =>
            const HelpCyclesPage(), // Uses the new full page name
  ...
  void _showLearnMoreArticle(String alertId) async {
    ...
    await showModalBottomSheet(
      ...
      backgroundColor: Colors.transparent,
      builder: (context) =>
          CycleDeviationModal(alertId: alertId), // Calls the new file
    );
        ...
        return StreamBuilder<QuerySnapshot>(
          ...
          builder: (context, cyclesSnapshot) {
            ...
            if (cyclesSnapshot.hasData) {
              recentCycles = cyclesSnapshot.data!.docs
            ...
            final DateTime lastPeriodStart =
                (userData['lastPeriodStart'] as Timestamp?)?.toDate() ??
            ...
            return StreamBuilder<QuerySnapshot>(
              stream: FirebaseFirestore.instance
                  ...
                  .where(
                    'date',
                    isGreaterThanOrEqualTo: dateOnly(lastPeriodStart),
                  )
                  .snapshots(),
              builder: (context, logsSnapshot) {
                ...
                if (logsSnapshot.hasData) {
                  for (var doc in logsSnapshot.data!.docs) {
                    ...
                    if (dateOnly(
                      logDate,
                    ).isAtSameMomentAs(dateOnly(simulatedToday))) {
                      todayLogData = log;
                      hasLoggedToday = true;
                    }
                  }
  ...
  Widget _buildMainDashboard(
    ...
    final alertBorderColor = isLightMode
        ? const Color(0xFFFFD8A8)
        : const Color(0xFF4A3215);
        ...
        children: [
          SingleChildScrollView(
            padding: EdgeInsets.only(
              ...
              left: 24.0,
              right: 24.0,
              bottom: safePadding.bottom + 140.0,
            ),
            child: Column(
              ...
              children: [
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    borderRadius: BorderRadius.circular(24),
                    border: Border.all(
                      color: pinkColor.withOpacity(isLightMode ? 0.15 : 0.3),
                    ),
                  ),
                  child: Row(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    ...
                    child: PremiumButton(
                      ...
                      onPressed: () {
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                            builder: (context) => DailyLoggingScreen(
      ...
      child: Row(
        ...
        children: [
          Icon(
            icon,
            size: 16,
            color: isLightMode ? Colors.grey[500] : Colors.white70,
          ),
          const SizedBox(width: 12),
          SizedBox(
            width: 80,
            child: Text(
              title,
              style: TextStyle(
                color: isLightMode ? Colors.grey[600] : const Color(0xFF9E9E9E),
                fontSize: 14,
                fontWeight: FontWeight.w500,
              ),
            ),
