    ...
    return FractionallySizedBox(
      ...
      child: Container(
        decoration: BoxDecoration(
          color: bgColor,
          borderRadius: const BorderRadius.vertical(top: Radius.circular(38)), // Matches exact radius
        ),
          ...
          children: [
            ...
            Expanded(
              child: SingleChildScrollView(
                physics: const BouncingScrollPhysics(), // Matches bouncing physics
                child: Column(
                    ...
                    Row(
                      ...
                      children: [
                        const Padding(
                          ...
                          child: Icon(Icons.auto_awesome, color: alertColor, size: 28),
                        ),
